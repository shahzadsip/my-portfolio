        ...
        <section className="experience" id="experience">
            <div className="container">
                <div className="section-header">
                    ...
                    <h2>Work Experience</h2>
                    <p className="section-description">
                        Building innovative web, mobile, and blockchain solutions across diverse industries
                    </p>
                </div>
                <div className="timeline">
                        ...
                        <div className="timeline-content">
                            <div className="timeline-header">
                                <div>
                                    ...
                                    <p className="company">Iconic Studio Pvt Ltd, UK</p>
                                </div>
                                <span className="timeline-date">2021 - Present</span>
                            </div>
                            <div className="timeline-description">
                                <p>Lead full-stack development and blockchain initiatives, delivering web, mobile, and Web3 solutions for enterprise and consumer projects.</p>
                                <ul className="timeline-highlights">
                                    <li>Developed Project79, Burlcore Marketplace, and Ocean Money platforms</li>
                                    <li>Built WorkHalo freelance marketplace with AI and blockchain integrations</li>
                                    <li>Implemented secure smart contracts, staking, NFT marketplaces, and DeFi solutions</li>
                                    <li>Managed teams, optimized scalable architectures, and ensured high-performance applications</li>
                                </ul>
                                <div className="timeline-skills">
                                    <span className="skill-badge">Solidity</span>
                                    <span className="skill-badge">React</span>
                                    ...
                                    <span className="skill-badge">Node.js</span>
                                    <span className="skill-badge">Blockchain</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="timeline-item">
                        ...
                        <div className="timeline-content">
                            <div className="timeline-header">
                                <div>
                                    <h3>Flutter Mobile & Web Developer</h3>
                                    <p className="company">Cyber Stellar Pvt Ltd, UK</p>
                                </div>
                                <span className="timeline-date">2019 - 2021</span>
                            </div>
                            <div className="timeline-description">
                                <p>Focused on building cross-platform mobile apps with Flutter and modern web applications.</p>
                                <ul className="timeline-highlights">
                                    <li>Developed the PresentedBy VIP mobile app for luxury concierge services</li>
                                    <li>Built WordPress websites and integrated custom backend solutions</li>
                                    <li>Implemented real-time chat and booking features in mobile applications</li>
                                </ul>
                                <div className="timeline-skills">
                                    <span className="skill-badge">Flutter</span>
                                    <span className="skill-badge">React</span>
                        ...
                        <div className="timeline-content">
                            <div className="timeline-header">
                                <div>
                                    ...
                                    <p className="company">Infinitum Innovation Pvt Ltd, Pakistan</p>
                                </div>
                                <span className="timeline-date">Mar 2014 - 2019</span>
                            </div>
                            <div className="timeline-description">
                                <p>Started career building websites, designing WordPress themes, and developing mobile applications.</p>
                                <ul className="timeline-highlights">
                                    <li>Designed and developed responsive WordPress websites for local clients</li>
                                    <li>Built the Credit Fix mobile app integrating backend APIs</li>
                                    <li>Worked on UI/UX improvements and content management solutions</li>
                                </ul>
                                <div className="timeline-skills">
                                    <span className="skill-badge">WordPress</span>
                                    <span className="skill-badge">PHP</span>
                                    <span className="skill-badge">HTML/CSS</span>
                                    <span className="skill-badge">Mobile Apps</span>
                                </div>
                            </div>
                        </div>
                    </div>
